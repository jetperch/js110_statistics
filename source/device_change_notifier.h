...
#ifndef DEVICE_CHANGE_NOTIFIER_H__
#define DEVICE_CHANGE_NOTIFIER_H__
 ...
 */
typedef void (*js110_device_change_notifier_callback)(void *cookie);
 ...
 */
int js110_device_change_notifier_initialize(
        js110_device_change_notifier_callback callback,
        void *cookie);
...
#endif /* DEVICE_CHANGE_NOTIFIER_H__ */
